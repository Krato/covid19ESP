const spanishCountriesData = [{
    ...
    "spanish": "Islas Ultramarinas Menores de Estados Unidos",
    ...
    "spanish": "Territorios Australes y Antárticas Franceses",
...
export function countriesInSpanish(iso){
    if (!iso) {
        return false;
    }
    return spanishCountriesData.find(info => {
        return info.iso3.match(iso.toUpperCase())
    })
}
